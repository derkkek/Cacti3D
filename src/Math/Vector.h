...
namespace Cacti
{
	...
	inline float Vec3::DistanceToPointFromLine(const Vec3& lineStart, const Vec3& lineEnd, const Vec3& pt)
	{
	...
	inline float Vec3::DistanceToPointFromTriangle(const Vec3& a, const Vec3& b, const Vec3& c, const Vec3& pt)
	{
		const Vec3 ab = b - a;
		const Vec3 bc = b - c;
	...
	inline Vec3 Vec3::FindFurthestPointFromLine(const Vec3& lineStart, const Vec3& lineEnd, const std::vector<Vec3>& points)
	{
	...
	inline Vec3 Vec3::FindFurthestPointFromTriangle(const Vec3& a, const Vec3& b, const Vec3& c, const std::vector<Vec3>& points)
	{
	...
	inline Tetrahedron Vec3::BuildTetrahedron(const std::vector<Vec3>& points)
	{
